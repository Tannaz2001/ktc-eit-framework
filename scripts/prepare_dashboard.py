...
Usage:
    ...
    python scripts/prepare_dashboard.py --output-dir outputs/
"""
...
# example_usage lives at the project root, not in the installed package.
sys.path.insert(0, str(Path(__file__).resolve().parents[1]))
from example_usage import project_to_dashboard  # noqa: E402
